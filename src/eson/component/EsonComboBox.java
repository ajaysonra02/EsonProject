...
import eson.component.util.ModernScrollBarUI;
import eson.core.autocomplete.AutoCompleteDecorator;
...
public class EsonComboBox<E> extends JComboBox<E> {
    ...
    protected class ComboSuggestionUI extends BasicComboBoxUI {
        ...
        private class ComboSuggestionPopup extends BasicComboPopup {
            ...
            protected JScrollPane createScroller() {
                ...
                JScrollBar sb = customScrollBar();
                sb.setPreferredSize(new Dimension(12, 70));
                scroll.setVerticalScrollBar(sb);
                JScrollBar sbH = customScrollBar();
            ...
            private JScrollBar customScrollBar() {
                JScrollBar retBar = new JScrollBar();
                retBar.setUI(new ModernScrollBarUI());
                retBar.setPreferredSize(new Dimension(8, 8));
                retBar.setForeground(new Color(180, 180, 180));
                retBar.setBackground(Color.WHITE);
                retBar.setUnitIncrement(20);
                return retBar;
            }
        }
