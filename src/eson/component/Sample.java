...
import eson.component.animator.Animator;
import eson.component.animator.TimingTargetAdapter;
    ...
    public Sample() {
        ...
        animator = new Animator(300, new TimingTargetAdapter() {
            ...
            public void timingEvent(float f) {
                int width = getWidth()+(int)(f*getWidth());
                int height = getHeight()+(int)(getHeight()*f);
